...
})({"5kQ90":[function(require,module,exports) {
...
class Router {
    ...
    navigate() {
        ...
        if (handler) handler();
        else console.error(`No route found for ${path}`);
    }
}
// Create a new router instance
const router = new Router();
// Define your routes
router.addRoute("/piedra-papel-tijera/", ()=>{
    (0, _inicio.inicioPage)() // Render the home page
    ;
});
router.addRoute("/", ()=>{
    (0, _inicio.inicioPage)() // Render the home page
...
router.addRoute("/reglas", ()=>{
    (0, _reglas.reglasPage)() // Render the reglas page
    ;
});
router.addRoute("/juego", ()=>{
    (0, _juego.juegoPage)() // Render the reglas page
    ;
});
...
},{"./pages/inicio":"eOBMs","./pages/juego":"kSEHS","./pages/reglas":"1qZI2"}],"eOBMs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "inicioPage", ()=>inicioPage);
function inicioPage() {
    function busquedaEIncerto() {
        const buscado = document.querySelector(".root");
        buscado.innerHTML = `
    <br />
...
},{}],"kSEHS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "juegoPage", ()=>juegoPage);
function juegoPage() {
    const appContainer = document.querySelector(".root");
    appContainer.innerHTML = `
    <div class="app" id="app"></div>
    <div class="primera-pagina-footer">
      <img src="https://svgshare.com/i/rY0.svg" alt="tijera" class="image" />
      <img src="https://svgshare.com/i/rYS.svg" alt="piedra" class="image" />
      <img src="https://svgshare.com/i/rXi.svg" alt="papel" class="image" />
    </div>
  `;
    const COLOR_CODES = {
        info: {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "reglasPage", ()=>reglasPage);
function reglasPage() {
    const buscado = document.querySelector(".root");
    buscado.innerHTML = `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5kQ90","4QFWt"], "4QFWt", "parcelRequirec4ed")
